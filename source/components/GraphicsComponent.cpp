...
// SpriteGraphicsComponent Part

SpriteGraphicsComponent::SpriteGraphicsComponent(float _Scale) : scale(_Scale) {
...
// SpriteSheetGraphicsComponent Part
...
{
    return spriteSheet.isCurrentAnimation(animationName);
}
